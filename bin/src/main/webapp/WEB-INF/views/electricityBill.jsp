...
<body class="w3-light-grey" background="https://images.pexels.com/photos/242236/pexels-photo-242236.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
	...
	<div class="w3-content w3-margin-top" style="max-width: 1400px;">
		...
		<div class="w3-row-padding">
			...
			<div class="w3-twothird">
				...
				<div class="w3-third">
					<form name="ElecrticityBill" action="saveBill" method="POST" modelAttribute="bill">
 ...
 <input id=billId type="hidden"  value="${bill.billId}" name="billId"  required  >
				...
				<div class="w3-twothird">
					...
					<input type="text" id="cardCVV" name="cardCVV"  value="${bill.cardCVV}" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em" onkeyup="validateCardCVV()" required >
					...
					<br> <br> <br> <br> <br> 
					 <br>
					<input type="submit" value="Save & Exit" name="save" formaction="saveForm" onsubmit="return validateForm()" formmethod="Post"
