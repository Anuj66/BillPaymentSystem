...
<form modelAttribute="bill" method="GET">
<!-- Page Container -->
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
         ...
         <br>
          ...
          <div class="w3-third" style="width:60%">
							...
							<tbody>
								<c:forEach var="tempbill" items="${bill}">
									...
									<tr>
										...
										<td>${tempbill.vendorName}</td>

										<c:if test="${tempbill.billStatus eq 'Paid'}">
											<td>${tempbill.amount}</td>
											<td>0</td>
											
										</c:if>
										
										<c:if test="${tempbill.billStatus eq 'Pending'}">
											<td>0</td>
												<td>${tempbill.amount}</td>
										</c:if>
