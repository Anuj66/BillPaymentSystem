...
function validateAge(){
	...
	if(isNaN(x)){
	text = "Should be a numerical value and valid age";
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                              <input  id="aadhar"name="aadhar" type="text" maxlength="12" class="form-control" placeholder=" Aadhar Number " onkeyup="validateAadhar()" required/>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="pan" name="pan"  type="text" maxlength="10" class="form-control" onkeyup="validatePan()" placeholder=" PAN Number " required/>
                                     ...
                                     <input name="role" type="hidden" value="ROLE_USER" required/>
                                        ...
                                        <input type="submit" class="btnRegister btn btn-success"  data-toggle="modal" data-target="#myModal"value="Register" required/>
