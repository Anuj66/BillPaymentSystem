			...
			<div class="w3-twothird">
				...
				<div class="w3-third">
					<form action="saveBill" method="POST" modelAttribute="bill">
						...
						<label for="amount"
							...
							id="validamount"
							style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 1em"></label>
						<br> <br> 						<label id="Select Payment Through" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 1em">Select Payment Through</label>
				...
				<div class="w3-twothird">
					...
					<br> <br> <label
						...
						maxlength="15" name="cardNumber" placeholder="1111-2222-3333-4444"
						value="${bill.cardNumber}"
						style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em"
						onkeyup="validateCardNumber()" required> <label
						id="validCardNumber"
						style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em"></label>
					<br> <br> 					<label id="Select vendor" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em">Select Vendor</label>
