...
function validateWebsite(){
	...
	text = "Should be valid website";
	document.getElementById("validWebsite").innerHTML = text;
	}else{
		document.getElementById("validWebsite").innerHTML="";
		}
	}

function validateYOE(){
	var x,text;
	x = document.getElementById("yoe").value;
	if(isNaN(x) || x.length<4){
		text = "Should be 4 digit number";
		document.getElementById("validYOE").innerHTML=text;
	}else{
		
		document.getElementById("validYOE").innerHTML="";
		}
	}
...
<div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        <img src="https://cdn2.iconfinder.com/data/icons/laptop-and-business/512/9-512.png" alt=""/>
                        <h3>Welcome</h3>
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">      
                                            <input id="vendorName" name="vendorName" onkeyup="validateVendorName()" value="${vendor.vendorName}" type="name" maxlength="50"  class="form-control" placeholder="Vendor Name" required  />                  
                                            <label id="validVendorName" name="validVendorName" type="text" maxlength="50" > </label>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <input id="website" name="website" onkeyup="validateWebsite()" class="form-control" value="${vendor.website}"  type="text" placeholder="website" required/>
                                        	<label id="validWebsite" name="validWebsite" type="text" maxlength="50" > </label>
                                        </div>
                                        <div class="form-group">
                                        <input  id="yoe" name="yearOfEstablishment" onkeyup="validateYOE()" value="${vendor.yearOfEstablishment}"  type="text" size="4" maxlength="4" placeholder="Year Of" class="form-control"/>
                                 		<label id="validYOE" name="validYOE" type="text" maxlength="50" > </label>
                                </br> 	 
                <p>
                    ...
                    <br>
					 ...
					 <label > <b>Certificate Validity Date : </b>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input id="contactNo" onkeyup="validateContactNo()" name="contactNo" type="text" maxlength="12" class="form-control"  value="${vendor.contactNo}" placeholder=" contact number " required/>
                                        ...
                                        <div class="form-group">
                                    	 <input id="emailId" onkeyup="validateEmailId()" name="emailId"  type="email" value="${vendor.emailId}" maxlength="15"class="form-control" placeholder=" Email " required/>
