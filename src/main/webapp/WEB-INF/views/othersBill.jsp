...
<body class="w3-light-grey" background="linear-gradient(-25deg, #616161 0%, #96B7C4 100%)">
			...
			<div class="w3-third">
				...
				<div class="w3-white w3-text-grey w3-card-4">
					...
					<div class="w3-container">
						...
						<br>
						<center><a href="back"><button type="button" class="btn btn-danger" >Back</button></a></center>
						<br>
 ...
 <input id=billId type="hidden"  value="${bill.billId}" name="billId"  required  >
						...
						<label for="username"
							...
							style="border: none; font-size: 1em; color: #818181; padding: 12px;" onkeyup="validateUsername()" readonly>
							<label	id = "validUsername" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 1em"></label>
							<br><br>
						...
						<label for="pan"
							...
							style="border: none; font-size: 1em; color: #818181; padding: 12px;" onkeyup="validatePan()">
							<label	id = "validPan" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 1em"></label>
							<br>
						...
						style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 0em"" onkeyup="validateamount()" required>
						<label	id = "validamount" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 1em"></label>
					<br> <br>
				...
				<div class="w3-twothird">
					...
					<label	style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em">Card Holder Name</label> <br> 
					<input type="text" id="cardName" name="cardName"  value="${bill.cardName}" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em" onkeyup="validateCardName()" required >
					<label	id = "validCardName" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em"></label>
					<br> <br>
					
					<label	style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em">Credit card CVV</label> <br> 
					<input type="password" id="cardCVV" name="cardCVV"  value="${bill.cardCVV}" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em" onkeyup="validateCardCVV()" required >
					<label	id = "validCardCVV" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em"></label>
					<br> <br> 
					
					<label	style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em">Credit card number</label> <br> 
					<input type="text" id="cardNumber" maxlength="15" name="cardNumber" placeholder="1111-2222-3333-4444" value="${bill.cardNumber}" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em" onkeyup="validateCardNumber()" required >
					<label	id = "validCardNumber" style="border: none; font-size: 1em; color: #818181; padding: 12px; margin-left: 10em"></label>
